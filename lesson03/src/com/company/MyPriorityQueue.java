...
public class MyPriorityQueue {
    ...
    //מקבלת מקוםפ של איבר קיים ומגדילה את ערכו
    ...
    //לקחתי את האיבר הוספתי לו ערך גדול ואז הוא עבר למקום הראשון הורדתי את כרכו שלא יהיה אובר פלו
